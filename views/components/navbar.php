  ...
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
      <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white">
        ...
        <li>
          <a href="/final-project/views/form.php" class="block py-2 px-3 text-<?php echo ($current_page == 'form.php' ? 'blue-700' : 'black'); ?> rounded <?php echo ($current_page != 'form.php' ? 'bg-blue-700' : ''); ?> hover:bg-black-800 md:bg-transparent md:hover:bg-transparent md:hover:text-blue-700 text-black-700 md:p-0">Form</a>
        </li>
        <li>
